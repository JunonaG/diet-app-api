...
async function mealRoutes(app) {
  app.post("/:userId/new-meal", async (request, reply) => {
    try {
      const createMealBodySchema = import_zod2.z.object({
        ...
        dietCompliance: import_zod2.z.boolean()
      });
      const createMealParamsSchema = import_zod2.z.object({
  ...
  app.get("/:mealId", async (request, reply) => {
    try {
      const viewMealParamsSchema = import_zod2.z.object({
        mealId: import_zod2.z.string()
      });
  ...
  app.patch("/title/:mealId", async (request, reply) => {
    try {
      const editMealTitleBodySchema = import_zod2.z.object({
        newTitle: import_zod2.z.string()
      });
      const editMealTitleParamsSchema = import_zod2.z.object({
        mealId: import_zod2.z.string()
      });
  ...
  app.patch("/description/:mealId", async (request, reply) => {
    try {
      const editMealDescBodySchema = import_zod2.z.object({
        newDescription: import_zod2.z.string()
      });
      const editMealDescParamsSchema = import_zod2.z.object({
        mealId: import_zod2.z.string()
      });
  ...
  app.patch("/when-consumed/:mealId", async (request, reply) => {
    try {
      const editMealWhenConsumedBodySchema = import_zod2.z.object({
        newWhenConsumed: import_zod2.z.string()
      });
      const editMealWhenConsumedParamsSchema = import_zod2.z.object({
        mealId: import_zod2.z.string()
      });
  ...
  app.patch("/diet-compliance/:mealId", async (request, reply) => {
    try {
      const editMealComplianceBodySchema = import_zod2.z.object({
        newComplianceRating: import_zod2.z.number()
      });
      const editMealComplianceParamsSchema = import_zod2.z.object({
        mealId: import_zod2.z.string()
      });
  ...
  app.get("/all/date/:when", async (request, reply) => {
    try {
      const dateParamsSchema = import_zod2.z.object({
        when: import_zod2.z.string()
      });
      const userBodySchema = import_zod2.z.object({
        userId: import_zod2.z.string()
      });
  ...
  app.get("/all/:userId", async (request, reply) => {
    try {
      const userIdParamsSchema = import_zod2.z.object({
        userId: import_zod2.z.string()
      });
